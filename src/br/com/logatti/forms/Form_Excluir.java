...
public class Form_Excluir extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Form_Excluir(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleParent(btn_limpa);
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        try {
            ...
            servico.excluiCliente(cpf);
            limpa_text();
            mensagem_Sucesso("E");
          txt_cpf.setEditable(true);
        } catch (RemoteException ex) {
            Logger.getLogger(Form_Excluir.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Form_Excluir dialog = new Form_Excluir(new javax.swing.JFrame(), true);
